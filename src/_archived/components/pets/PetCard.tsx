...
export function PetCard({ pet, onDeleted, onRefresh }: { pet: Pet; onDeleted?: () => void; onRefresh?: () => void }) {
    ...
    <Card className="overflow-hidden hover:shadow-lg transition-shadow">
      <div className="aspect-square bg-muted relative">
        ...
        <PetPhotoUpload
          petId={pet.id}
          petName={pet.name}
          photos={pet.AnimalPhoto || []}
          onPhotosChange={onRefresh || (() => {})}
        />
        <DropdownMenu>
      ...
      <CardContent className="p-4 space-y-3">
        ...
        <Button
          ...
          onClick={() => navigate(`/dashboard?tab=appointments&petId=${pet.id}`)}
        >
